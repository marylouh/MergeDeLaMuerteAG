...
public class DataSetDao {
	...
	public void persistence() {
		...
		firstAmap.setLocalisation(sdAddress);
		...
		firstAmap.setLocalisation(tdAddress);
		...
		firstAmap.setLocalisation(ftAddress);
		...
		firstAmap.addSupplier(firstSupProd);
		...
		secondAmap.addSupplier(secondSupProd);
		...
		thirdAmap.addSupplier(activitySupplier);
		...
		fourthAmap.addSupplier(sndSupplier);
...
//				Basket bp3 = new Basket();
		...
		administrator.setLoginAdmin("admin@gmail.com");
